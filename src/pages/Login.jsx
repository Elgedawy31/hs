...
useEffect(() => {
  ...
  return (
   <div style={{backgroundColor:theme.body, color:theme.text}}> <AnimatedBackground>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <motion.div 
                ...
                variants={itemVariants}
              >
                <h1 className="text-2xl md:text-3xl font-bold mb-2 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Welcome Back</h1>
                <p className="text-placeholderText">Login to your account</p>
              </motion.div>
