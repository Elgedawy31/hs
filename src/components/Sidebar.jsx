  ...
  const MenuItem = ({ icon: Icon, label, path }) => (
    ...
    >
      ...
      className={`absolute left-0 w-[2px] sm:w-[3px] h-full transform transition-all duration-300 ease-in-out 
          ${path === "" ? ((location?.pathname === "/dashboard" || location.pathname ==='/dashboard/') ? 'bg-primary scale-y-100' : 'bg-transparent scale-y-0 group-hover:scale-y-100 group-hover:bg-primary/50') 
      ...
      <div
        className={`flex items-center w-full px-3 sm:px-4 py-2 transform transition-all duration-300 ease-in-out
          ${path === "" ? ((location?.pathname === "/dashboard" || location.pathname ==='/dashboard/') ? 'bg-secondPrimaryColor translate-x-1' : 'bg-transparent hover:translate-x-1 hover:bg-secondPrimaryColor/50')
      ...
      >
        <Icon
          className={`w-5 h-5 sm:w-6 sm:h-6 transition-transform duration-300 ease-in-out group-hover:scale-110 
            ${path === "" ? ((location?.pathname === "/dashboard" || location.pathname ==='/dashboard/') ? 'text-primary' : 'text-text')
