...
function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row" style={{backgroundColor: theme.body, color: theme.text}}>
      {/* Form with fixed width */}
      <div className="w-full md:w-[500px] flex items-center justify-center p-4">
        <div className="w-full p-6 md:p-8 rounded-lg shadow-lg" style={{backgroundColor: theme.background}}>
      ...
      {/* Spline component taking remaining width, hidden on small screens */}
